...
export function INTRINSICS_String_prototype_lastIndexOf ($ : LiftedTransfer, $this : Lifted<unknown>, searchString : Lifted<unknown>, position : Lifted<unknown> = $.default<undefined>(undefined, [])) {
