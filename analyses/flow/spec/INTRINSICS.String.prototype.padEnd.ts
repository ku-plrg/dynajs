...
export function INTRINSICS_String_prototype_padEnd ($ : LiftedTransfer, $this : Lifted<unknown>, maxLength : Lifted<unknown>, fillString : Lifted<unknown> = $.default<undefined>(undefined, [])) {
