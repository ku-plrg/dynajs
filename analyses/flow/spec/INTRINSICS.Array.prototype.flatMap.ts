...
export function INTRINSICS_Array_prototype_flatMap ($ : LiftedTransfer, $this : Lifted<unknown>, mapperFunction : Lifted<unknown>, thisArg : Lifted<unknown> = $.default<undefined>(undefined, [])) {
