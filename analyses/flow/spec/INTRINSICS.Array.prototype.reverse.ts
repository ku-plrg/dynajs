...
export function INTRINSICS_Array_prototype_reverse ($ : SpecRuntime, $this : Lifted<unknown>) {
  ...
  while ($.value($.condition(Number.MAX_SAFE_INTEGER - 196, $.isNot(lower, middle))))
  {
    ...
    if ($.value($.condition(Number.MAX_SAFE_INTEGER - 197, $.is(lowerExists, $.default<boolean>(true, [])))))
    {
    ...
    if ($.value($.condition(Number.MAX_SAFE_INTEGER - 198, $.is(upperExists, $.default<boolean>(true, [])))))
    {
      var upperValue = AO__Get($, (O as Lifted<unknown>), (upperP as Lifted<unknown>));
    }

    if ($.value($.condition(Number.MAX_SAFE_INTEGER - 199, $.is(lowerExists, $.default<boolean>(true, [])))) && $.value($.condition(Number.MAX_SAFE_INTEGER - 200, $.is(upperExists, $.default<boolean>(true, [])))))
    {
    ...
    {
      if ($.value($.condition(Number.MAX_SAFE_INTEGER - 201, $.is(lowerExists, $.default<boolean>(false, [])))) && $.value($.condition(Number.MAX_SAFE_INTEGER - 202, $.is(upperExists, $.default<boolean>(true, [])))))
      {
        AO__Set($, (O as Lifted<unknown>), (lowerP as Lifted<unknown>), (upperValue as Lifted<unknown>), ($.default<boolean>(true, []) as Lifted<boolean>));
      ...
      {
        if ($.value($.condition(Number.MAX_SAFE_INTEGER - 203, $.is(lowerExists, $.default<boolean>(true, [])))) && $.value($.condition(Number.MAX_SAFE_INTEGER - 204, $.is(upperExists, $.default<boolean>(false, [])))))
        {
