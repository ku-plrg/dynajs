...
export function INTRINSICS_String_prototype_repeat ($ : SpecRuntime, $this : Lifted<unknown>, count : Lifted<unknown>) {
  ...
  if ($.value($.condition(Number.MAX_SAFE_INTEGER - 452, $.lessThan(n, $.default<number>(0, [])))) || $.value($.condition(Number.MAX_SAFE_INTEGER - 453, $.is(n, $.default<number>(Infinity, [])))))
  {
    throw new RangeError;
  }

  if ($.value($.condition(Number.MAX_SAFE_INTEGER - 454, $.is(n, $.default<number>(0, [])))))
  {
