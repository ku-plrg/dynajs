...
export function INTRINSICS_String_prototype_replace ($ : SpecRuntime, $this : Lifted<unknown>, searchValue : Lifted<unknown>, replaceValue : Lifted<unknown>) {
  ...
  if (!($.value($.condition(Number.MAX_SAFE_INTEGER - 455, $.is(searchValue, $.default<undefined>(undefined, [])))) || $.value($.condition(Number.MAX_SAFE_INTEGER - 456, $.is(searchValue, $.default<null>(null, []))))))
  {
    var replacer = AO__GetMethod($, (searchValue as Lifted<unknown>), ($.default<symbol>(Symbol.replace, []) as Lifted<unknown>));
    if (!$.value($.condition(Number.MAX_SAFE_INTEGER - 457, $.is(replacer, $.default<undefined>(undefined, [])))))
    {
  ...
  if ($.value($.condition(Number.MAX_SAFE_INTEGER - 458, $.is(functionalReplace, $.default<boolean>(false, [])))))
  {
  ...
  if ($.value($.condition(Number.MAX_SAFE_INTEGER - 459, $.is(position, $.default<string>("not-found", [])))))
  {
    return string;
  }
  ...
  if ($.value($.condition(Number.MAX_SAFE_INTEGER - 460, $.is(functionalReplace, $.default<boolean>(true, [])))))
  {
