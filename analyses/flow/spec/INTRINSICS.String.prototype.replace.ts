...
export function INTRINSICS_String_prototype_replace ($ : SpecRuntime, $this : Wrapped<unknown>, searchValue : Wrapped<unknown>, replaceValue : Wrapped<unknown>) {
  ...
  if (!($.condition(Number.MAX_SAFE_INTEGER - 427, $.is(searchValue, $.lit<undefined>(undefined))) || $.condition(Number.MAX_SAFE_INTEGER - 428, $.is(searchValue, $.lit<null>(null)))))
  {
    var replacer = AO__GetMethod($, (searchValue as Wrapped<unknown>), ($.lit<symbol>(Symbol.replace) as Wrapped<unknown>));
    if (!$.condition(Number.MAX_SAFE_INTEGER - 429, $.is(replacer, $.lit<undefined>(undefined))))
    {
  ...
  if ($.condition(Number.MAX_SAFE_INTEGER - 430, $.is(functionalReplace, $.lit<boolean>(false))))
  {
  ...
  if ($.condition(Number.MAX_SAFE_INTEGER - 431, $.is(position, $.lit<string>("not-found"))))
  {
    return string;
  }
  ...
  if ($.condition(Number.MAX_SAFE_INTEGER - 432, $.is(functionalReplace, $.lit<boolean>(true))))
  {
