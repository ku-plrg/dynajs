...
export function INTRINSICS_Array_prototype_includes ($ : LiftedTransfer, $this : Lifted<unknown>, searchElement : Lifted<unknown>, fromIndex : Lifted<unknown> = $.default<undefined>(undefined, [])) {
