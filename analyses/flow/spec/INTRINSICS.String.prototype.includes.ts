...
export function INTRINSICS_String_prototype_includes ($ : SpecRuntime, $this : Lifted<unknown>, searchString : Lifted<unknown>, position : Lifted<unknown> = $.default<undefined>(undefined, [])) {
  ...
  if ($.value($.condition(Number.MAX_SAFE_INTEGER - 430, $.is(isRegExp, $.default<boolean>(true, [])))))
  {
    throw new TypeError;
  }
  ...
  if ($.value($.condition(Number.MAX_SAFE_INTEGER - 431, $.is(index, $.default<string>("not-found", [])))))
  {
