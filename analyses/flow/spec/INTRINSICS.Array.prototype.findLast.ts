...
export function INTRINSICS_Array_prototype_findLast ($ : SpecRuntime, $this : Lifted<unknown>, predicate : Lifted<unknown>, thisArg : Lifted<unknown> = $.default<undefined>(undefined, [])) {
