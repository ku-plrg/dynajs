...
export type CodeSite = { kind: 'code'; id: number; file: string; start: Pos; end: Pos };
export type Site =
  | CodeSite
...
export function resolveCodeSite(id: number): Site {
  ...
  return { kind: 'code', id, file, start: { line: loc[0], column: loc[1] }, end: { line: loc[2], column: loc[3] } };
}
