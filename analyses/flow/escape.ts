...
export type EscapeRecord = { container: object; prop: string | symbol; wrapped: Wrapped<unknown> };
...
export class BoundaryEscape {
  ...
  markEscapableLiteral(value: unknown): void {
    if (this.containersMayHoldWrapped || typeof value !== 'object' || value === null) return;
