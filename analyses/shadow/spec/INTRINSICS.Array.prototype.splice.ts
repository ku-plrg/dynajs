...
export function INTRINSICS_Array_prototype_splice ($ : LiftedTransferOps, $this : Lifted<unknown>, start : Lifted<unknown>, deleteCount : Lifted<unknown>, ...items : Lifted<unknown>[]) {
