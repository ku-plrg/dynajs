...
export function INTRINSICS_Array_prototype_reduce ($ : LiftedTransfer, $this : Lifted<unknown>, callback : Lifted<unknown>, initialValue : Lifted<unknown> = $.default<undefined>(undefined, [])) {
