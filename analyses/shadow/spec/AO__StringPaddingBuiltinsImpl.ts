...
export function AO__StringPaddingBuiltinsImpl ($ : LiftedTransfer, O : Lifted<unknown>, maxLength : Lifted<unknown>, fillString : Lifted<unknown>, placement : Lifted<unknown>) {
