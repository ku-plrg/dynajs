...
export function INTRINSICS_String_prototype_padEnd ($ : LiftedTransferOps, $this : Lifted<unknown>, maxLength : Lifted<unknown>, fillString : Lifted<unknown> = $.default<undefined>(undefined, [])) {
