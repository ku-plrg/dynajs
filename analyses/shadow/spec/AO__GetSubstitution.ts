...
export function AO__GetSubstitution ($ : LiftedTransferOps, matched : Lifted<string>, str : Lifted<string>, position : Lifted<number>, captures : Lifted<string | undefined>[], namedCaptures : Lifted<unknown>, replacementTemplate : Lifted<string>) {
