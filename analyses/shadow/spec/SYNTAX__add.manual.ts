...
function SYNTAX__add_primitive($: LiftedTransfer, lPrim: Lifted<Primitive>, rPrim: Lifted<Primitive>): Lifted<string> | Lifted<number> {
...
export function SYNTAX__add($: LiftedTransfer, lVal: Lifted<unknown>, rVal: Lifted<unknown>): Lifted<string> | Lifted<number> {
