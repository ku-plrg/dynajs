...
export function INTRINSICS_Array_prototype_findLastIndex ($ : LiftedTransferOps, $this : Lifted<unknown>, predicate : Lifted<unknown>, thisArg : Lifted<unknown> = $.default<undefined>(undefined, [])) {
