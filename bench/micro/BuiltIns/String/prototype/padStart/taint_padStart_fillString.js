...
function __test_taint__(tainted) {
    ...
    // @witness __test_taint__('x') => x.padStart(4,tainted)[1]='x' (tainted fill)
    __assert_taint__(x.padStart(4, tainted)[1], true);

    // @witness always x.padStart(4,tainted)[2]='h' (clean receiver)
    __assert_taint__(x.padStart(4, tainted)[2], false);
