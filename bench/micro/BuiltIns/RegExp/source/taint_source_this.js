...
function __test_taint__(tainted) {
    ...
    // @witness __test_taint__('b') => s[0] = 'b' tainted
    ...
    // @witness always s2[0] = 'a', clean (from literal pattern, not tainted)
    __assert_taint__(s2[0], false);

    // @witness always s2[1] = 'b', clean (from literal pattern, not tainted)
