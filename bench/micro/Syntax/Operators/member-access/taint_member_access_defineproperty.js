...
function __test_taint__(tainted) {
    ...
    // @witness __test_taint__("Hello") => tm_a.b = "Hello" tainted
    ...
    var tm_e = {b: tainted};
    // @witness __test_taint__("Hello") => tm_e = {b:"Hello"} tainted (all props tainted)
    __assert_taint__(tm_e, true);
    Object.defineProperty(tm_e, 'd', {value: 'Test'});
    // @witness clean defined property 'Test', clean
