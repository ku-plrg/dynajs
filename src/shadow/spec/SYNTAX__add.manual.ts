...
function SYNTAX__add_primitive($: LiftedTransferOps, lPrim: Lifted<Primitive>, rPrim: Lifted<Primitive>): Lifted<string> | Lifted<number> {
...
export function SYNTAX__add($: LiftedTransferOps, lVal: Lifted<unknown>, rVal: Lifted<unknown>): Lifted<string> | Lifted<number> {
