...
export function INTRINSICS_Array_prototype_lastIndexOf ($ : LiftedTransferOps, $this : Lifted<unknown>, searchElement : Lifted<unknown>, fromIndex : Lifted<unknown> = $.default<undefined>(undefined, [])) {
