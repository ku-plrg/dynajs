...
export function INTRINSICS_String_prototype_includes ($ : LiftedTransferOps, $this : Lifted<unknown>, searchString : Lifted<unknown>, position : Lifted<unknown> = $.default<undefined>(undefined, [])) {
