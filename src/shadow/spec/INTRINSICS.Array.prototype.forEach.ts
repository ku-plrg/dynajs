...
export function INTRINSICS_Array_prototype_forEach ($ : LiftedTransferOps, $this : Lifted<unknown>, callback : Lifted<unknown>, thisArg : Lifted<unknown> = $.default<undefined>(undefined, [])) {
