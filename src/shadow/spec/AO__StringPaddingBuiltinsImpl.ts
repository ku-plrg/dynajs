...
export function AO__StringPaddingBuiltinsImpl ($ : LiftedTransferOps, O : Lifted<unknown>, maxLength : Lifted<unknown>, fillString : Lifted<unknown>, placement : Lifted<unknown>) {
