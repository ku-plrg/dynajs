...
export function AO__FindViaPredicate ($ : LiftedTransferOps, O : Lifted<unknown>, len : Lifted<number>, direction : Lifted<unknown>, predicate : Lifted<unknown>, thisArg : Lifted<unknown>) {
