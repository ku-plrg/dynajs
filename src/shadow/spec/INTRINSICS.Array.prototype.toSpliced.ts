...
export function INTRINSICS_Array_prototype_toSpliced ($ : LiftedTransferOps, $this : Lifted<unknown>, start : Lifted<unknown>, skipCount : Lifted<unknown>, ...items : Lifted<unknown>[]) {
