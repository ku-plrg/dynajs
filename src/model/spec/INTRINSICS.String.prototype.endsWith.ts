...
export function INTRINSICS_String_prototype_endsWith ($ : BootStrap, $this : Wrapped<unknown>, searchString : Wrapped<unknown>, endPosition? : Wrapped<unknown>) {
  ...
  var len = $.length(S);
  if ($.is(endPosition, $.base<undefined>(undefined, [])))
  {
    var pos = len;
  }
  else
