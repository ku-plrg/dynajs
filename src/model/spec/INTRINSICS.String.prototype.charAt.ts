...
export function INTRINSICS_String_prototype_charAt ($ : BootStrap, $this : Wrapped<unknown>, pos : Wrapped<unknown>) {
  ...
  return $.substring(S, position, $.add(position, $.base<number>(1, [])));
}
