...
export function INTRINSICS_String_prototype_repeat ($ : SpecRuntime, $this : Wrapped<unknown>, count : Wrapped<unknown>) {
  ...
  if ($.condition(Number.MAX_SAFE_INTEGER - 373, $.lessThan(n, $.base<number>(0, []))) || $.condition(Number.MAX_SAFE_INTEGER - 374, $.is(n, $.base<number>(Infinity, []))))
  {
    throw new RangeError;
  }

  if ($.condition(Number.MAX_SAFE_INTEGER - 375, $.is(n, $.base<number>(0, []))))
  {
    return $.base<string>("", []);
  }
